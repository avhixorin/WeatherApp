...
const ToggleSwitch = () => {
  ...
  return (
    <label className="relative inline-block w-16 h-9">
      ...
      <span className="absolute left-1 top-1 h-7 w-7 rounded-full bg-gray-500 shadow-md transition-transform duration-300 peer-checked:translate-x-7 cursor-pointer"></span>
    </label>
  );
};
