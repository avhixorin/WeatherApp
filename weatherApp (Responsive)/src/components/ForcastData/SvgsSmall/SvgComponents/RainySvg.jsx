...
function RainySvg() {
  return (
    ...
    <svg height="45px" width="45px" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg" fill="#071952" className="dark:fill-white" stroke="#ffffff">
    ...
    <g id="SVGRepo_iconCarrier">
      ...
      <path 
        ...
        style={{ fill: "none", stroke: "#ffffff", strokeLinejoin: "round", strokeWidth: "32px" }}
      />
      <line 
        x1="144" 
        y1="384" 
        x2="112" 
        y2="432" 
        style={{ fill: "none", stroke: "#ffffff", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "32px" }}
      />
      <line 
        x1="224" 
        y1="384" 
