    ...
    <div className='w-full h-full flex flex-col p-[25%] gap-4'>
      <div className='flex flex-row gap-6'>
        ...
        <div className='flex justify-center items-center'>
          <svg fill="#ffffff" className='hover:fill-slate-300 hover:cursor-pointer' height="80px" width="80px" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="-48.5 -48.5 582.00 582.00" xmlSpace="preserve" stroke="#ffffff" strokeWidth="0.00485" transform="rotate(0)">
            <g id="SVGRepo_bgCarrier" strokeWidth="0"/>
            <g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round" stroke="#CCCCCC" strokeWidth="0.9700000000000001"/>
      ...
      <div className='text-white text-lg font-lg'>
